...
const MoviePage = () => {
  ...
  useEffect(() => {
    if (filterDebounce) {
      setUrl(
        "https://api.themoviedb.org/3/search/movie?api_key=dae28cb2a8dbebf72e0eacb8a51b947a"
      );
    } else {
      setUrl(
        "https://api.themoviedb.org/3/movie/popular?api_key=dae28cb2a8dbebf72e0eacb8a51b947a&query = ${filterDebounce}"
      );
    }
  }, [filterDebounce]);
